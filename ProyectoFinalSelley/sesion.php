<!DOCTYPE html>
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <div class="container">
        <form role="form" action="checarsesion.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="password" name="pwd" class="form-control" id="pwd" placeholder="Enter password" value="">
          </div>
          <div class="checkbox">
            <label><input type="checkbox"> Remember me</label>
          </div>
          <button type="submit" class="btn btn-default">Submit</button>
          <a href="crearcuenta.php"><button type="button" class="btn btn-default">Crear Cuenta</button></a>
        </form>
      </div>
    </div>
  </div>
