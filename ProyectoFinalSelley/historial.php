      ...
      while($row = mysqli_fetch_array($resultado)){
        ...
        echo"<thead>";
          ...
          echo"</tr>";
            ...
            mysqli_close($con);
          ?><a href="borrarhistorial.php"><button type="button" class="btn btn-default">Borrar Historial</button></a><?
    }else{
      ?>
      <div class="container">
        <div class="jumbotron">
          <h2>No tiene permiso para ver el historial.</h2>
        </div>
      </div>
      <?
    }
