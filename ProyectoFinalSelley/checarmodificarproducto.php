 ...
 $id=$_GET['idnum'];
  ...
  if (mysqli_connect_errno()) {
    ...
    if($_SESSION['root']==1){
      ...
      $query="UPDATE producto SET nombre='$nombre', precio='$precio', descripcion='$descripcion', cantidad_almacen='$almacen', fabricante='$fabricante', origen='$origen', imagen='$imagen', clasificacion='$clasificacion' WHERE idproducto='$id';";
  ...
  ?>
      <div class="container">
        <div class="jumbotron">
          <h2>No tiene permiso para modificar.</h2>
        </div>
      </div>
  <?
    }
