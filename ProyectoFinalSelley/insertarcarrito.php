...
<!DOCTYPE html>
  ...
  <?php
    ...
    $query="SELECT nombre, precio FROM producto WHERE idproducto='$id';";
    ...
    $query2="INSERT into carrito (idorden_detalle, producto_idproducto, producto_nombre, producto_precio, usuario_idusuario, total) values('$idorden_detalle' , '$id', '$nombre', '$precio', '$otra', '$precio');";
  ...
  <div class="container">
    <div class="jumbotron">
      <h2>Artículo insertado con éxito</h2>
    </div>
  </div>
