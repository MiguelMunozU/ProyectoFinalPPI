...
<!DOCTYPE html>
  ...
  <?php
    ...
    $otra=$_SESSION['id'];
    $query3="SELECT * FROM carrito WHERE usuario_idusuario='$otra';";

    $resulta=mysqli_query($con,$query3);
        ...
        echo "<div class='container'>";
          echo "<table class='table'>";
            ...
            while($row = mysqli_fetch_array($resulta)) {
              echo "<tr>";
                echo "<td>" . $row['producto_idproducto'] . "</td>";
...
<br>
<center><a href="pagar.php"><button type="button" class="btn btn-default">Pagar</button></a>
<a href="borrarcarrito.php"><button type="button" class="btn btn-default">Borrar Carrito</button></a>
